...
SLIDES: list[tuple[str, str, str]] = [
    ...
    (
        "c__Users_octav_AppData_Roaming_Cursor_User_workspaceStorage_ef7a66e609e3feb7feecf43b802b548a_images_13-8437cb5f-84dd-467d-99b3-db6809001904.png",
        "AI Tutor",
        "Instant explanations for tough concepts",
    ),
    (
    ...
    (
        ...
        "Subscriptions",
        "Upgrade, restore purchases, and legal info",
    ),
]
...
def main() -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "Generated by `python scripts/generate-app-store-screenshots.py`.",
        ]
    )
