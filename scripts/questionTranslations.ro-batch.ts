...
export const questionTranslations: Record<string, Record<string, QuestionTranslation>> = {
  ...
  "rv1": {
    "ro": {
      "question": "Câte vertebre cervicale, toracice și lombare sunt prezente în coloana vertebrală adultului tipic?",
      "options": [
        "C7, T10, L5",
        "C7, T12, L5",
        "C6, T12, L4",
      ...
      "explanation": "Segmentele mobile ale coloanei vertebrale adulte constau din 7 vertebre cervicale, 12 vertebre toracice și 5 vertebre lombare."
    }
  },
  "rv2": {
    "ro": {
      "question": "Care caracteristică este CEA MAI specifică pentru vertebrele cervicale tipice (C3–C6)?",
      "options": [
        "Corpi mari în formă de rinichi și absența foramenelor transversale",
        "Prezența foramenelor transversale și adesea procese spinoase bifide (împărțite)",
        "Fete costale pe corpi pentru capetele coastelor",
        "Procese spinoase masive care se proiectează orizontal",
        "Fuzionarea corpurilor vertebrale într-un singur os"
      ],
      "explanation": "Vertebrele cervicale tipice au corpuri mici, foramen vertebrale mari în formă de triunghi, foramen transversale în procesele transversale și adesea procese spinoase bifide."
    }
  },
  "rv3": {
    "ro": {
      "question": "Care caracteristici distinctive sunt asociate cu vertebrele toracice tipice?",
      "options": [
        "Foramen transversale și procese unciate",
        "Corpi vertebrali în formă de inimă, procese spinoase lungi înclinate în jos și fete costale pentru articulația cu coastele",
        "Corpi masivi în formă de rinichi fără fete costale și procese spinoase scurte și obtuze",
        "Foramen vertebrale mari în formă de triunghi fără articulații cu coastele",
        "Fuzionare completă în sacru"
      ],
      "explanation": "Vertebrele toracice tipice (T2–T9) au corpuri în formă de inimă, fete costale pe corpi și procese transversale pentru articulația cu coastele și procese spinoase lungi, orientate inferior."
    }
  },
  "rv4": {
    "ro": {
      "question": "Care caracteristici caracterizează CEL MAI bine vertebrele lombare tipice?",
      "options": [
        "Corpi mici, delicati cu foramen transversale",
        "Corpi de dimensiuni medii și fete costale pentru coaste",
        "Corpi mari în formă de rinichi cu procese spinoase scurte, groase, în formă de secure și fără fete costale",
        "Procese spinoase fuzionate și foramen sacral",
        "Procese spinoase bifide și procese unciate"
      ],
      "explanation": "Vertebrele lombare au corpuri vertebrale mari, în formă de rinichi, pedicule robuste, procese spinoase scurte și late și lipsesc foramen transversale sau fete costale, reflectând rolul lor de suport pentru greutate."
    }
  },
  "rv5": {
    "ro": {
      "question": "Care combinație se potrivește corect cu planurile principale de orientare a articulațiilor facetare (zygapophyseal) în regiunile cervicale, toracice și lombare?",
      "options": [
        "Cervical: sagital; toracic: coronal; lombar: orizontal",
        "Cervical: oblic (între orizontal și coronal); toracic: coronal; lombar: sagital",
        "Cervical: coronal; toracic: sagital; lombar: orizontal",
        "Toate regiunile: pur orizontale",
        "Toate regiunile: pur sagitale"
      ],
      "explanation": "Fetele cervicale sunt orientate oblic (permițând mișcare multi-axială), fetele toracice sunt mai coronal (favorizează rotația, limitează flexia/extensia) și fetele lombare sunt în principal sagitale (favorizează flexia/extensia, limitează rotația)."
    }
  },
  "rv6": {
    "ro": {
      "question": "Funcțional, care afirmație rezumă CEL MAI bine diferențele generale între regiunile vertebrale cervicale, toracice și lombare?",
      "options": [
        "Coloana cervicală prioritizează suportul pentru greutate; toracica prioritizează mobilitatea; lombara este imobilă",
        "Regiunea cervicală prioritizează mobilitatea capului și gâtului; regiunea toracică pune accent pe stabilitate și suportul cutiei toracice; regiunea lombară pune accent pe suportul pentru greutate și flexie–extensie în partea inferioară a spatelui",
        "Toate cele trei regiuni au roluri identice de mobilitate și distribuire a sarcinii",
        "Regiunea toracică permite cea mai mare flexie–extensie; cervicala și lombara stabilizează în principal cutia toracică",
        "Regiunea lombară este cea mai mobilă și cea mai puțin încărcată porțiune a coloanei vertebrale"
      ],
      "explanation": "Vertebrele cervicale susțin și mișcă capul cu o mobilitate mare; vertebrele toracice, articulate cu coastele, oferă stabilitate și protejează organele toracice; vertebrele lombare sunt mari și robuste pentru suportul greutății și flexie–extensie a trunchiului."
    }
  },
  "tv1": {
    "ro": {
      "question": "Care caracteristică DISTINGUĂ CEL MAI bine vertebrele toracice de vertebrele cervicale și lombare?",
      "options": [
        "Prezența foramenelor transversale",
        "Prezența fetelor costale pentru articulația cu coastele",
        "Procese spinoase bifide",
        "Corpi mari în formă de rinichi",
        "Absența foramenelor vertebrale"
      ],
      "explanation": "Vertebrele toracice au în mod unic fete costale (sau demi-fete) pe corpurile și procesele transversale pentru articulația cu capetele și tuberculii coastelor."
    }
  },
  "tv2": {
    "ro": {
      "question": "Care vertebre sunt considerate \"tipice\" vertebre toracice?",
      "options": [
        "T1 și T12",
        "T2 până la T9",
        "T10, T11 și T12",
        "Numai T1",
        "Toate vertebrele toracice T1–T12"
      ],
      "explanation": "Vertebrele toracice tipice sunt T2–T9; au corpuri în formă de inimă, fete costale pe corpi și procese transversale și procese spinoase lungi, înclinate inferior."
    }
  },
  "tv3": {
    "ro": {
      "question": "Care descriere caracterizează CEL MAI bine procesele spinoase ale vertebrelor toracice tipice?",
      "options": [
        "Scurte și bifide ca procesele spinoase cervicale",
        "Lungi, subțiri și se proiectează brusc inferoposterior, adesea suprapunând vertebra de dedesubt",
        "Late și orizontale ca procesele spinoase lombare",
        "Absente în majoritatea vertebrelor toracice",
        "Complet fuzionate pentru a forma sacrul"
      ],
      "explanation": "Procesele spinoase toracice tipice sunt lungi, subțiri și se înclină abrupt inferior, adesea suprapunând următoarea vertebră, ceea ce limitează extensia coloanei toracice."
    }
  },
  "tv4": {
    "ro": {
      "question": "Cum se articulează fetele costale ale unei vertebre toracice medii tipice (de exemplu, T6) cu coastele?",
      "options": [
        "Corpul are două fete costale complete pentru capetele a două coaste diferite",
        "Corpul are demi-fete superioare și inferioare care se articulează fiecare cu jumătate dintr-un cap de coastă, iar procesul transversal are o fațetă pentru tuberculul coastei",
        "Numai procesele transversale au fațete; corpurile nu au",
        "Coastele nu se articulează cu vertebrele toracice",
        "Procesul spinos se articulează cu tulpinile coastelor"
      ],
      "explanation": "În vertebrele toracice tipice, corpul are demi-fete superioare și inferioare (jumătate-fete) care împreună cu vertebrele adiacente formează fete complete pentru capetele coastelor, iar fiecare proces transversal are o fațetă pentru tuberculul corespondent al coastei."
    }
  },
  "tv5": {
    "ro": {
      "question": "Care vertebre toracice sunt considerate atipice și au adesea modele diferite de fațete costale?",
      "options": [
        "T2–T9",
        "T1, T10, T11 și T12",
        "Numai T6 și T7",
        "Niciuna; toate vertebrele toracice sunt identice",
        "T5–T8"
      ],
      "explanation": "T1 are adesea o fațetă costală superioară completă pentru coasta 1; T10–T12 pot avea doar fațete complete unice pe corpurile lor (T10) sau lipsesc fațetele costale transversale (T11, T12), făcându-le atipice."
    }
  },
  "tv6": {
    "ro": {
      "question": "Care este semnificația funcțională a orientării articulațiilor fațetelor toracice (zygapophyses)?",
      "options": [
        "Permite flexie și extensie maxime, la fel ca fațetele lombare",
        "Sunt orientate într-un plan coronal (frontal), ceea ce facilitează rotația și îndoirea laterală, dar limitează flexia și extensia",
        "Sunt complet orizontale, permițând doar rotația",
        "Sunt sagitale, la fel ca fațetele lombare",
        "Nu au suprafețe articulare"
      ],
      "explanation": "Articulațiile zygapophyseal toracice sunt orientate mai coronal, ceea ce permite rotația și flexia laterală, dar restricționează mișcarea în plan sagital, contribuind la stabilitatea toracică cu cutia toracică."
    }
  },
  "tv7": {
    "ro": {
      "question": "Care vertebră toracică servește adesea ca vertebră de tranziție cu caracteristici intermediare între vertebrele toracice și cele lombare?",
      "options": [
        "T1",
        "T6",
        "T12",
      ...
      "explanation": "T12 este de tranziție; poate lipsi fațetele costale inferioare și are caracteristici asemănătoare vertebrelor lombare, inclusiv procese transversale mai late și un proces spinos mai orizontal."
    }
  },
  "lv1": {
    "ro": {
      "question": "Care caracteristică caracterizează CEL MAI mult vertebrele lombare comparativ cu vertebrele cervicale și toracice?",
      "options": [
        "Prezența foraminelor transversale",
        "Prezența fațetelor costale pentru coaste",
        "Corpi mari, în formă de rinichi și procese robuste adaptate pentru suportul greutății",
        "Procese spinoase bifide",
        "Procese spinoase lungi, înclinate inferior"
      ],
      "explanation": "Vertebrele lombare au corpuri masive, în formă de rinichi, pedicule groase și lame, și procese spinoase scurte și late, reflectând rolul lor major în suportul greutății."
    }
  },
  "lv2": {
    "ro": {
      "question": "Câte vertebre lombare sunt de obicei prezente în coloana vertebrală a adultului?",
      "options": [
        "Patru",
        "Cinci",
        "Șase",
      ...
      "explanation": "Coloana lombară tipică constă din cinci vertebre lombare, L1 până la L5."
    }
  },
  "lv3": {
    "ro": {
      "question": "Care descriere caracterizează CEL MAI bine procesele spinoase ale vertebrelor lombare?",
      "options": [
        "Lungi, subțiri și înclinate inferior, la fel ca procesele spinoase toracice",
        "Scurte, bifide și posteroinferioare, la fel ca cele cervicale",
        "Scurte, late, cvadrangulare (în formă de secure) și proiectate orizontal posterior",
        "Complet absente",
        "Fuzionate într-un creasta continuă"
      ],
      "explanation": "Procesele spinoase lombare sunt scurte, groase, cvadrangulare și se proiectează aproape orizontal, oferind zone mari de atașare pentru mușchii spatelui."
    }
  },
  "lv4": {
    "ro": {
      "question": "Care este orientarea fațetelor articulare (articulațiile zygapophyseal) în vertebrele lombare și ce mișcări permite aceasta?",
      "options": [
        "Orientare coronală care permite în principal rotația",
        "Orientare sagitală (sau aproape sagitală) care permite în principal flexia și extensia, limitând rotația",
        "Orientare orizontală care permite doar compresia",
        "Orientare oblică care permite mișcare egală în toate planurile",
        "Orientare aleatorie fără un model funcțional"
      ],
      "explanation": "Articulațiile fațetelor lombare sunt orientate într-un plan sagital (fațetele superioare orientate posteromedial, fațetele inferioare anterolateral), ceea ce permite flexia și extensia, dar restricționează rotația axială."
    }
  },
  "lv5": {
    "ro": {
      "question": "Ce structuri se proiectează lateral din arcele vertebrale lombare și sunt omologe cu coastele?",
      "options": [
        "Procese spinoase",
        "Procese articulare",
        "Procese transversale (elemente costale)",
        "Pedicule",
        "Lame"
      ],
      "explanation": "Procesele transversale lombare sunt subțiri, se proiectează lateral și reprezintă elemente costale fuzionate (echivalente cu coastele), oferind atașare pentru mușchi."
    }
  },
  "lv6": {
    "ro": {
      "question": "Care vertebră lombară prezintă adesea anatomie de tranziție cu sacrumul (sacralizare sau lombarizare)?",
      "options": [
        "L1",
        "L2",
        "L3",
      ...
      "explanation": "L5 poate prezenta caracteristici de tranziție, cum ar fi fuzionarea parțială sau completă cu sacrumul (sacralizare), sau invers, S1 poate rămâne separat (lombarizare), afectând biomecanica."
    }
  },
  "lv7": {
    "ro": {
      "question": "Care este semnificația clinică a corpurilor vertebrale mari și a pediculelor scurte și groase ale vertebrelor lombare?",
      "options": [
        "Reduc dimensiunea canalului vertebral, crescând riscul de compresie a măduvei",
        "Oferă maximă rezistență pentru suportul greutății, dar lasă recessuri laterale și foramină intervertebrală relativ înguste, predispunând la compresia rădăcinilor nervoase cu hernie de disc sau stenoză",
        "Elimină necesitatea discurilor intervertebrale",
        "Previn orice mișcare a coloanei lombare",
        "Nu au relevanță clinică"
      ],
      "explanation": "Anatomia robustă lombară susține sarcini grele, dar combinația dintre corpurile mari, pediculele scurte și groase și procesele articulare superioare orientate posterior creează foramină intervertebrală și recessuri laterale relativ strânse, crescând vulnerabilitatea la comprimarea rădăcinilor nervoase."
    }
  },
  "sa1": {
    "ro": {
      "question": "Care afirmație descrie CEL MAI BINE sacrumul?",
      "options": [
        "O singură vertebră lombară",
        "Oase triunghiular format prin fuziunea a cinci vertebre sacre, situat între cele două oase pelvine",
        "Segmentul terminal al coccisului",
        "O vertebră toracică mobilă",
        "Parte a coloanei vertebrale cervicale"
      ],
      "explanation": "Sacrumul este un os mare, triunghiular, fuzionat, format din cinci vertebre sacre (S1–S5) care se articulează cu oasele iliace ale pelvisului și formează peretele posterior al pelvisului."
    }
  },
  "sa2": {
    "ro": {
      "question": "Care suprafețe ale sacrumului se articulează lateral cu oasele iliace pentru a forma articulațiile sacroiliace?",
      "options": [
        "Suprafața anterioară (pelvină)",
        "Suprafața posterioară",
        "Suprafețele laterale care poartă suprafețele auriculare",
        "Apicele sacrumului",
        "Creasta mediană sacrala"
      ],
      "explanation": "Suprafețele laterale ale sacrumului au suprafețe auriculare în formă de ureche care se articulează cu oasele iliace la articulațiile sacroiliace."
    }
  },
  "sa3": {
    "ro": {
      "question": "Care foramina de pe suprafața anterioară (pelvină) a sacrumului transmit ramurile anterioare ale nervilor spinali sacri?",
      "options": [
        "Foramina intervertebrale",
        "Foramina transversale",
        "Foramina sacrale anterioare (pelvine)",
        "Foramina sacrale posterioare",
        "Foramina vertebrale"
      ],
      "explanation": "Patru perechi de foramina sacrale anterioare (pelvine) de pe suprafața concavă pelvină transmit ramurile anterioare ale nervilor spinali S1–S4."
    }
  },
  "sa4": {
    "ro": {
      "question": "Care creste de pe suprafața posterioară a sacrumului reprezintă resturi fuzionate ale proceselor vertebrale?",
      "options": [
        "Creasta mediană sacrala (procese spinoase fuzionate), creste intermediare (procese articulare fuzionate) și creste laterale (procese transversale fuzionate)",
        "Doar creasta mediană sacrala",
        "Suprafețele auriculare și cornua sacrale",
        "Foramina sacrale anterioare",
        "Promontoriul și ala"
      ],
      "explanation": "Sacrumul posterior prezintă o creastă mediană sacrala (procese spinoase fuzionate), creste intermediare pereche (procese articulare fuzionate) și creste laterale (procese transversale fuzionate)."
    }
  },
  "sa5": {
    "ro": {
      "question": "Ce este promontoriul sacral și de ce este important clinic?",
      "options": [
        "Apicele sacrumului care se articulează cu coccisul",
        "Marginea superioară anterioară proeminentă a S1, formând marginea posterioară a orificiului pelvin și un reper obstetric",
        "Aripa laterală a sacrumului",
        "Creasta mediană posterioară",
        "Capătul inferior al canalului sacral"
      ],
      "explanation": "Promontoriul sacral este marginea superioară anterioară proeminentă a corpului S1; marchează limita posterioară a orificiului pelvin și este un reper cheie în pelvimetria obstetrică."
    }
  },
  "sa6": {
    "ro": {
      "question": "Ce deschidere de la capătul inferior al canalului sacral este delimitată de cornua sacrale și transmite al cincilea nerv sacral?",
      "options": [
        "Foramen sacral anterior",
        "Foramen sacral posterior",
        "Hiatus sacral",
        "Foramen intervertebral",
        "Suprafața auriculară"
      ],
      "explanation": "Hiatusul sacral este o deficiență în formă de U la capătul inferior al canalului sacral, formată prin fuziunea incompletă a laminae-urilor S5, delimitată de cornua sacrale; transmite rădăcinile nervoase S5 și este utilizat pentru anestezia epidurală caudală."
    }
  },
  "sa7": {
    "ro": {
      "question": "Funcțional, care afirmație rezumă CEL MAI BINE rolul sacrumului în scheletul axial și pelvis?",
      "options": [
        "Oferă mobilitate între trunchi și membrele inferioare",
        "Servește ca principală piatră de temelie pentru suportul greutății, transmitând greutatea de la coloana axială la centura pelvină și membrele inferioare prin articulațiile sacroiliace, și formează peretele posterior al pelvisului",
        "Este pur protector, fără rol mecanic",
        "Adăpostește doar măduva osoasă",
        "Permite rotația pelvisului independent de coloană"
      ],
      "explanation": "Sacrumul acționează ca o piatră de temelie între coloană și pelvis, transmitând greutatea corporală de la coloana vertebrală prin articulațiile sacroiliace către oasele pelvine și membrele inferioare, și formează peretele rigid posterior al cavității pelvine."
    }
  },
  "aa1": {
    "ro": {
      "question": "Care afirmație descrie CEL MAI BINE vertebra atlas (C1)?",
      "options": [
        "Are un corp vertebral mare și un dens în formă de dinte",
        "Nu are un corp vertebral și proces spinos, formând un inel cu arce anterioare și posterioare și două mase laterale",
        "Are fațete costale pentru articulația coastei",
        "Are procese transversale fuzionate formând sacrumul",
        "Are un proces spinos lung, înclinat în jos"
      ],
      "explanation": "Atlasul are formă de inel, cu arce anterioare și posterioare și mase laterale pereche; nu are un corp vertebral tipic și proces spinos."
    }
  },
  "aa2": {
    "ro": {
      "question": "Care caracteristică este CEL MAI caracteristică pentru vertebra ax (C2)?",
      "options": [
        "Prezența doar a unor foramina transversale mari",
        "Prezența unui proces odontoid proeminent (dens) care se proiectează superior din corp",
        "Absenta completă a corpului vertebral",
        "Fuziunea cu osul occipital",
        "Fațete costale pentru capetele coastelor"
      ],
      "explanation": "Semnul distinctiv al axului este procesul odontoid (dens), o proiecție puternică în formă de dinte din corp care acționează ca un pivot pentru rotația atlasului și a capului."
    }
  },
  "aa3": {
    "ro": {
      "question": "Care este mișcarea principală permisă la articulația atlanto-occipitală între atlas și condilul occipital?",
      "options": [
        "Rotația capului, ca în a clătina capul \"nu\"",
        "Flexia și extensia capului, ca în a înclina capul \"da\"",
        "Flexia laterală doar",
        "Compresia axială a coloanei",
        "Mișcări de alunecare ale coastelor"
      ],
      "explanation": "Articulațiile atlanto-occipitale între fațetele articulare superioare ale atlasului și condilul occipital permit în principal flexia și extensia, producând mișcarea de înclinare \"da\"."
    }
  }
};
