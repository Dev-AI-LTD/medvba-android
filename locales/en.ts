export const en: Record<string, string> = {
  ...
  'onboarding.slide3.title': 'Learn First',
  'onboarding.slide3.subtitle': 'Chapter Study',
  'onboarding.slide3.description': 'Read concise chapter summaries and listen to recorded audio before you quiz. Understand each topic, then test yourself.',
  ...
  'quiz.readChapterSummary': 'Summary',
  'quiz.studyCardTitle': 'Study',
  'quiz.studyCardSubtitle': 'Chapter summaries',
  ...
  'session.readChapterSummary': 'Read chapter summary',
  ...
  'module.medAdmission': 'Medical School Entrance Exam',
  ...
  'study.mcq': 'MCQ',
  'study.hubTitle': 'Study',
  'study.hubSubtitle': 'Chapter summaries — understand the topic before the quiz',
  'study.chaptersSubtitle': 'Summaries and per-chapter quiz',
  'study.moduleComingSoon': 'Coming soon',
  'study.moduleChapters': '{count} chapters',
  'study.moduleSummaries': '{published} summaries published',
  'study.chapterFree': 'Free',
  'study.chapterPremium': 'Premium',
  'study.chapterComingSoon': 'Coming soon',
  'study.readSummary': 'Read summary',
  'study.listenSummary': 'Listen to summary',
  'study.playAudio': 'Play audio',
  'study.pauseAudio': 'Pause audio',
  'study.stopAudio': 'Stop',
  'study.audioTtsFallback': 'On-device speech',
  'study.audioError': 'Could not play audio. Check volume and your device text-to-speech settings.',
  'study.audioTtsUntilRebuild': 'Reinstall the app (bun run android) for recorded voice',
  'study.audioStreaming': 'Recorded voice (MP3)',
  'study.audioBuffering': 'Loading audio…',
  'study.audioStreamRetryHint': 'MP3 temporarily unavailable — using device voice',
  'study.audioRetryMp3': 'Retry recorded voice',
  'study.startChapterQuiz': 'Quiz this chapter',
  'study.summaryNotFound': 'Summary is not available for this chapter yet.',
  'study.summaryApiUnavailable': 'Could not load from the server. Retry or check your connection.',
  'study.summaryOfflinePreview': 'Shown from offline preview bundle.',
  'study.lockedTitle': 'Premium summary',
  ...
  'tabs.study': 'Study',
  'tabs.studyIconA11y': 'Study tab',
  'tabs.social': 'Chats',
  'tabs.socialIconA11y': 'Chats tab',

  // Messenger (Social tab)
  'messenger.title': 'Chats',
  'messenger.activeNow': 'Active now',
  'messenger.noChats': 'No conversations yet',
  'messenger.noChatsHint': 'Start a chat from Active now or Find study partners',
  'messenger.noOneActive': 'No one active right now. Find students to message.',
  'messenger.findPartners': 'Find study partners',
  'messenger.findStudents': 'Find students',
  'messenger.backToChats': 'Chats',
  'messenger.chatDbMigrationHint':
    'Chat database needs a one-time update in Supabase. Run migration 014_direct_chats_fk_profiles.sql, then try again.',
  'messenger.searchPlaceholder': 'Search chats',
  'messenger.typeMessage': 'Message',
  'messenger.online': 'Online',
  'messenger.offline': 'Offline',
  'messenger.unknownUser': 'Student',
  'tabs.tutor': 'AI Tutor',
  ...
  'leaderboard.emptyMessage': 'No scored activity for this period yet. Keep practicing to appear here.',
  'leaderboard.errorTitle': "Couldn't load leaderboard",
  'leaderboard.errorMessage': 'Something went wrong while loading rankings. Check your connection and try again.',
  ...
  'clinical.casesTools': 'Cases & tools',
  'clinical.casesToolsHide': 'Hide cases & tools',
  'clinical.casesToolsShow': 'Cases & tools',
  'clinical.disclaimerCompact': 'Educational disclaimer accepted',
  ...
  'social.subtitle': 'Message classmates and find study partners in the app.',
  ...
  'social.reportSubmitFailed': 'Could not send your report. Check your connection and try again.',
  'social.done': 'Done',
  ...
  'settings.premiumSource.none': 'Status: Free (paywall on)',
  'settings.premiumSource.store': 'Status: Premium via App Store',
  'settings.premiumSource.server': 'Status: Premium via server grant',
  'settings.premiumSource.review': 'Status: Premium via review bypass',
  'settings.premiumSource.paywall_off': 'Status: Paywall disabled',
  ...
  'privacy.messagingData': 'Messages:',
  'privacy.messagingDataDesc': 'When you use Chat, we store messages you send to other users and related metadata needed to deliver the feature.',
  'privacy.aiTutorData': 'AI Tutor:',
  'privacy.aiTutorDataDesc':
    'Questions you submit to the AI tutor and the responses generated for you. We process this content on our servers to provide the feature; we do not use it for advertising.',
  ...
  'privacy.supabaseDesc': 'Database hosting and data storage',
  'privacy.kinde': 'Kinde:',
  'privacy.kindeDesc': 'Authentication and identity management',
  'privacy.revenueCat': 'RevenueCat:',
  'privacy.revenueCatDesc': 'Subscription and in-app purchase management (when you use Premium)',
  'privacy.openai': 'OpenAI:',
  'privacy.openaiDesc':
    'AI model provider used to generate tutor responses from your questions (processed on our backend; not used for ads)',
  ...
  'privacy.useInfo3': 'Enable social features like chat with study partners and leaderboards',
  'privacy.useInfo4':
    'Send important notifications about your account (e.g. study reminders, if you enable them)',
  'privacy.useInfo5': 'Operate the AI tutor and subscription features',
  'privacy.useInfo6': 'Respond to your support requests and review user reports',
  'privacy.useInfo7': 'Analyze usage patterns to improve user experience',
  ...
  'privacy.rightErasureDesc':
    'Request deletion of your personal data (including in-app Delete Account)',
  ...
  'premium.feature9': 'Full chapter summaries + audio (Study)',
};
