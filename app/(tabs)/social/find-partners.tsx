            ...
            try {
              ...
              const code =
                error && typeof error === 'object' && 'code' in error
                  ...
                  : '';
              Alert.alert(
                t('userProfile.startChatErrorTitle'),
                code === '23503'
                  ? t('messenger.chatDbMigrationHint')
                  : t('userProfile.startChatErrorMessage'),
              );
            }
          }}
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        <View style={styles.header}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Filter color={activeFiltersCount > 0 ? colors.text : colors.textSecondary} size={iconLg} />
        ...
        <View style={styles.searchSection}>
          <View style={styles.searchBar}>
            <Search color={colors.textMuted} size={iconMd} />
            <TextInput
            ...
            {searchQuery.length > 0 && (
              <TouchableOpacity onPress={() => setSearchQuery('')}>
                <X color={colors.textMuted} size={iconMd} />
              </TouchableOpacity>
            )}
          </View>
        </View>
