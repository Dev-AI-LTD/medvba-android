...
| 6 | **Review Notes** + ASC Username/Password | 2.1 | ✅ Docs | `app-store-metadata-en.md` → Username ASC `boctavian2014@gmail.com`; premium demo `contact@devaieood.com` in Notes. Screenshots: paywall at #2 in `docs/app-store-screenshots/ios-6.5/`. |
